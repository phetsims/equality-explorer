...
(5) Open in the browser: `http://localhost/equality-explorer/equality-explorer_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/equality-explorer/build/adapted-from-phet/equality-explorer_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
