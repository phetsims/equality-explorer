...
define( function( require ) {
  ...
  function createItemCreators( numberOfItemsOnScale ) {
    ...
    var index = 0;
    return [
      new ConstantItemCreator( 2, ItemIcons.SPHERE_NODE, ItemIcons.SPHERE_SHADOW_NODE, {
        numberOfItemsOnScale: numberOfItemsOnScale[ index++ ]
      } ),
      new ConstantItemCreator( 3, ItemIcons.SQUARE_NODE, ItemIcons.SQUARE_SHADOW_NODE, {
        numberOfItemsOnScale: numberOfItemsOnScale[ index++ ]
      } ),
