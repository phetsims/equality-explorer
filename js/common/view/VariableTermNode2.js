...
//TODO merge into VariableTermNode
/**
...
define( function( require ) {
  ...
  /**
   * @param {VariableTerm2} term
   * @param {Object} [options]
   * @constructor
   */
  function VariableTermNode2( term, options ) {

    assert && assert( term instanceof VariableTerm2, 'term has wrong type' );
  ...
  equalityExplorer.register( 'VariableTermNode2', VariableTermNode2 );

  return inherit( TermNode2, VariableTermNode2 );
} );