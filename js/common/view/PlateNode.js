...
define( function( require ) {
  ...
  function PlateNode( plate, options ) {
    ...
    var outsideSVG = 'M245.633,70.359c-1.15,1.836-1.764,1.672-7.195,3.125c-20.375,5.45-68.705,9-137.838,9c-65.326,0-110.102-2.84-131.033-7.493c-7.123-1.584-9.441-1.76-11.35-4.132c-1.295-1.611-11.043-3.625-8.484-8.625c2.043-3.994,79.203-6.75,150.867-6.75c72.723,0,147.553,1.775,150.016,5.75C254.025,66.734,246.588,68.836,245.633,70.359';
    var outsideNode = new Path( outsideSVG, {
      fill: options.color,
      stroke: 'black',
      lineWidth: 1
    } );
    ...
    // See assets/README.md for more details.
    var surfaceSVG = 'M243.527,69.984c0,2.25-64.234,8.75-143,8.75c-78.764,0-142.25-5.988-142.25-9.25c0-5.25,63.836-10.462,142.602-10.462S243.527,64.484,243.527,69.984';
    var surfaceNode = new Path( surfaceSVG, {
    ...
    // See assets/README.md for more details.
    var insideSVG = 'M251.869,68.484c0,7.364-67.6,13.333-150.99,13.333c-83.389,0-150.988-5.969-150.988-13.333c0-7.363,67.6-13.333,150.988-13.333C184.27,55.151,251.869,61.121,251.869,68.484';
    var wallNode = new Path( insideSVG, {
    ...
    var rimNode = new Path( insideSVG, {
