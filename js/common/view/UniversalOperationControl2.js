...
define( function( require ) {
   ...
   * @constructor
   */
  function UniversalOperationControl2( scene, animationLayer, options ) {
    ...
    var operatorRadioButtons = new RadioButtonGroup( scene.operatorProperty, operatorItems, {
    ...
    assert && assert( !options.children, 'UniversalOperationControl2 sets children' );
    options.children = [ operatorRadioButtons, operandPicker, goButton ];
  ...
  equalityExplorer.register( 'UniversalOperationControl2', UniversalOperationControl2 );
  ...
  return inherit( HBox, UniversalOperationControl2, {
