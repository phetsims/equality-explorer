...
[TermCreator] is the base type for creating and managing terms. It uses the PhET [creator pattern], described more in the [Common Patterns]() section.  Term creators are responsible for creating and managing terms.  There is a subtype for each term type, namely [ConstantTermCreator], [VariableTermCreator] and [ObjectTermCreator].
